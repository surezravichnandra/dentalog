...
<head>
	...
	<link href="css/pws-payment.css" rel="stylesheet">
														...
														<div class="col-xs-12">
															...
															<div class="checkout-panel">
																	...
																	<div class="payment-method">
																		<label for="card" class="method card">
																			<div class="card-logos">
																				<img src="img/visa-logo.png" width="150" />
																		...
																		<label for="paylater" class="method paypal">
																			<img src="img/cashhand.png" width="37" height="37" />
																			<div class="radio-input">
																				<input id="paylater" type="radio" name="payment">
																				Pay Later
																			</div>
																		</label>
																	</div>
																		...
																		<div class="column-1">
																			...
																			<div class="small-inputs">
																				<div>
																					...
																					<input type="text" id="datep" placeholder="MM / YY" />
																				</div>
																...
																<div class="panel-footer">
																	...
																	<button class="btn next-btn" id="pay" >Pay Now</button>
																	<button class="btn next-btn" id="proceed" style="display: none;">Proceed</button>
																</div>
															</div>
