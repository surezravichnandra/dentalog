...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ URL::asset('admins/plugins/iCheck/square/blue.css')}}">
...
<div class="login-box">
  <div class="login-logo">
    <a href="./index.html"><b>Prowess</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
...
<!-- iCheck -->
<script src="{{ URL::asset('admins/plugins/iCheck/icheck.min.js')}}"></script>
<script>
  $(function () {
    $('input').iCheck({
