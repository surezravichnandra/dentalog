            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12">
                  ...
                  <a class="btn btn-primary float-right" style="margin-right: 5px;" href="{{ url('/') }}/admin/pdfview/{{ $data->bill_number }}">
...
<script type="text/javascript">
  function billprint(){
    ...
    setTimeout(function(){ 
      ...
      window.location.href = "{{URL::to('/')}}/admin/medicineBill"
    }, 500);
  }
