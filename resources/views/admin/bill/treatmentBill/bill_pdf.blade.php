...
@foreach($datas as $data)
    ...
    <main>
      ...
      <table>
        <thead>
          <tr>
            <th class="unit"  colspan="2">#</th>
            <th class="desc">Service</th>
            <th class="unit">Discount Amount</th>
        ...
        <tbody>
          ...
          @foreach($datas as $data)
          <tr>
            <td class="unit "  colspan="2">{{ $sl++ }}</td>
            <td class="desc">{{ $data->service->services }}</td>
            <td class="unit">{{ $data->discount_amount }}</td>
            <td class="desc">{{ $data->total_amount }}</td>
        ...
        <tfoot>
          <tr>
            ...
            <td style="font-family: DejaVu Sans, sans-serif; text-align: center;"> ₹ {{ $discount_amount }}</td>
          </tr>
          <tr>
            <td colspan="2"></td>
            <td colspan="2"> Grand Total : </td>
            <td style="font-family: DejaVu Sans, sans-serif; text-align: center;"> ₹ {{ $data->payment->total_amount }}</td>
          </tr>
        </tfoot>
      </table>
