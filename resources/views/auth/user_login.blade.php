              ...
              <div class="modal-body">
                <div class="tab-content">
                  <div id="login-form" class="tab-pane fade in active">
                    <form action="{{ route('user.auth') }}" method="POST" id="logForm">
                        {{ csrf_field() }}
                      <div class="form-group">
                        <label for="user" class="pws-login-label">MobileNumber / Email ID</label>
                        <input type="text" class="form-control pws-mobileinput" id="user" name="user" aria-describedby="emailHelp" placeholder="MobileNumber / Email ID">
                      </div>
                      <div class="form-group">
                        <label for="pass" class="pws-login-label">Password</label>
                        <input type="password" class="form-control pws-mobileinput" id="pass" name="pass" placeholder="Password">
                      </div>
                    ...
                    <button type="button"   class="btn btn-default pws-login-btn" id="pws_login">Login</button>
                  </form>
                </div>
...
//if the check box is checked the password field is disabled
