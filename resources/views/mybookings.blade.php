    ...
    <ul class="list-unstyled components">
      ...
      <li class="active">
        ...
        <li>
          ...
          <!-- <div class="container">
          <a href="#" class="pws-subnav-text">Booking history</a>
          </div> -->
          </div>
        </nav>
        <br>
                      ...
                      <div class="col-xs-10">
                        <div class="pws-dr-name">
                         ...
                         <div class="col-xs-12">
                           <div class="col-xs-8">
                             ...
                             <div class="col-md-4">
                              <center>
                                ...
                                <span class="pws-available"><i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp; On 10th June ,2018</span></center>
                              </div>
                            </div>
                            <br>
                            <ul class="pws-slotes">
                           ...
                           <button class="pws-btn-cancel pull-right"> <i class="fa fa-bolt" aria-hidden="true"></i>&nbsp;Cancel Appoinmnet</button>
                          </div>
                        </div>
                      </div>
                    </div>
